...
const BUSINESS_CATEGORY: CategoryConfig = {
  ...
  allToolIds: ["business-contract-generator", "nda-generator", "invoice-generator", "estimate-generator", "invoice-tax-simulator", "resignation-letter-generator", "certified-letter-generator", "hanko-generator", "pdf-signature", "receipt-generator", "resume-builder"],
  stats: [
    { label: "ビジネスツール数", value: "11種類" },
    { label: "利用料金", value: "完全無料" },
    { label: "登録・インストール", value: "不要" },
...
const AI_CATEGORY: CategoryConfig = {
  ...
  popularToolIds: ["ai-email", "ai-keigo", "prompt-builder", "chatgpt-format", "ai-humanize"],
  allToolIds: ["ai-email", "ai-keigo", "ai-apology", "ai-decline", "ai-inquiry", "prompt-builder", "chatgpt-format", "ai-humanize", "x-post-preview", "note-format"],
  stats: [
    { label: "AIツール数", value: "10種類" },
    { label: "利用料金", value: "完全無料" },
    { label: "登録・インストール", value: "不要" },
    { label: "処理場所", value: "ブラウザ完結" },
  ],
  faqs: [
    { q: "ビジネスメールや敬語の文面も作れますか？", a: "はい。AIメール作成では依頼・お礼・日程調整などのメール文面を、AI敬語変換ではくだけた表現を丁寧な敬語に変換できます。謝罪文・断り文・問い合わせ文の専用ツールもあります。" },

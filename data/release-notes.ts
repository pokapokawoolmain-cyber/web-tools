...
export const RELEASE_NOTES: ReleaseNote[] = [
  {
    ...
    href: "/tools/invoice-tax-simulator",
    title: "インボイス税額シミュレーターを公開",
    body: "インボイスの「2割特例」が2026年9月30日を含む課税期間で終了することを踏まえ、廃止後に選ぶべき簡易課税・本則課税の消費税納税額を自動比較できるツールを公開しました。売上・経費・業種（みなし仕入率）を入力するだけで、3方式のうち最も有利な方式が一目でわかります。",
  },
  {
    date: "2026-09-06",
    type: "NEW",
    target: "年賀状じまい・喪中はがき文例メーカー",
    href: "/tools/nenga-jimai-maker",
    title: "年賀状じまい・喪中はがき文例メーカーを公開",
    body: "年賀状じまい（年賀状の卒業）と喪中はがきの文例を、理由や続柄を選ぶだけで自動作成できるツールを公開しました。コピー・印刷・Word形式ダウンロードに対応し、送るべき時期やマナーの解説もあわせて掲載しています。",
  },
  {
    date: "2026-09-06",
    type: "NEW",
    target: "命名書メーカー",
    href: "/tools/meimeisho-maker",
    title: "命名書メーカーを公開",
    body: "赤ちゃんのお七夜に飾る命名書を、毛筆風フォントで無料作成できるツールを公開しました。正式書式・略式書式の両方に対応し、そのままA4・色紙サイズで印刷できます。",
  },
  {
    date: "2026-08-19",
    type: "NEW",

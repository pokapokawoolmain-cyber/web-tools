...
export const TOOLS: ToolItem[] = [
  ...
  { id: "image-converter", title: "画像一括変換", seoTitle: "画像一括変換｜JPG・PNG・WebP・AVIFをまとめて変換【無料】", description: "JPG・PNG・WebP・AVIFをブラウザ内で一括変換。20枚以上対応・用途別プリセット・変換前後比較・ZIP一括DL。ファイルは外部に送信されません。", href: "/tools/image-converter", emoji: "🖼️", category: "画像・PDF", isNew: true, isPopular: true, updatedAt: "2026-08-19" },
  ...
  { id: "pdf-to-excel", title: "PDF→Excel変換", seoTitle: "PDFをExcelに変換｜表・文字を.xlsxに抽出【無料・ブラウザ完結】", description: "PDFの表や文字を読み取ってExcel（.xlsx）に変換。請求書・明細・名簿の表をスプレッドシート化。ファイルはサーバーに送信されません。", href: "/tools/pdf-to-excel", emoji: "📊", category: "画像・PDF", isNew: true, updatedAt: "2026-08-15" },
  { id: "pdf-to-word", title: "PDF→Word変換", seoTitle: "PDFをWordに変換｜文章を編集できる文書に【無料・ブラウザ完結】", description: "PDFの文章を読み取ってWordで編集できる文書に変換。契約書・報告書の文字を再利用。ファイルはサーバーに送信されません。", href: "/tools/pdf-to-word", emoji: "📝", category: "画像・PDF", isNew: true, updatedAt: "2026-08-15" },
  ...
  { id: "webcam-test", title: "Webカメラテスト", seoTitle: "Webカメラテスト｜カメラが映るかブラウザで即チェック【無料】", description: "カメラが正しく映るかをブラウザで確認。映像プレビューと解像度表示、前面／背面の切り替えに対応。録画・送信なし。", href: "/tools/webcam-test", emoji: "📷", category: "生活・副業", isNew: true, updatedAt: "2026-08-14" },
  { id: "speaker-test", title: "スピーカーテスト", seoTitle: "スピーカーテスト｜左右(L/R)の音をブラウザでチェック【無料】", description: "スピーカー・イヤホンの左右（L/R）が正しく鳴るかをブラウザで確認。左・右・両方のテスト音を再生。", href: "/tools/speaker-test", emoji: "🔊", category: "生活・副業", isNew: true, updatedAt: "2026-08-14" },
  { id: "dead-pixel-test", title: "ドット抜けチェッカー", seoTitle: "ドット抜けチェッカー｜全画面の単色で画素不良を確認【無料】", description: "全画面の単色表示で、モニターやスマホ画面のドット抜け・画素欠けを確認。赤・緑・青・白・黒などを順に表示。", href: "/tools/dead-pixel-test", emoji: "🟥", category: "生活・副業", isNew: true, updatedAt: "2026-08-14" },
  { id: "screen-resolution", title: "画面解像度チェッカー", seoTitle: "画面解像度チェッカー｜今の解像度・ウィンドウサイズを確認【無料】", description: "今の画面解像度・物理解像度・表示領域・ピクセル比・アスペクト比を自動表示。ウィンドウサイズはリアルタイム更新。", href: "/tools/screen-resolution", emoji: "🖥️", category: "生活・副業", isNew: true, updatedAt: "2026-08-14" },
  { id: "refresh-rate", title: "リフレッシュレート測定", seoTitle: "リフレッシュレート測定｜モニターが何Hzかブラウザで確認【無料】", description: "モニターやスマホが実際に何Hzで動作しているかをブラウザで測定。60/120/144Hzなどを約2秒で判定。", href: "/tools/refresh-rate", emoji: "📺", category: "生活・副業", isNew: true, updatedAt: "2026-08-14" },
  ...
  { id: "invoice-tax-simulator", title: "インボイス税額シミュレーター", seoTitle: "インボイス税額シミュレーター｜2割特例廃止後は簡易課税と本則課税どちらが得？", description: "2割特例廃止後に選ぶべき簡易課税・本則課税の消費税納税額を、売上・経費・業種から自動比較。フリーランス・個人事業主向け。", href: "/tools/invoice-tax-simulator", emoji: "🧾", category: "ビジネス・契約書", isNew: true, updatedAt: "2026-09-06" },
  ...
  { id: "nenga-jimai-maker", title: "年賀状じまい・喪中はがき文例メーカー", seoTitle: "年賀状じまい・喪中はがき文例メーカー【無料】そのまま使える例文", description: "年賀状じまい・喪中はがきの文例を無料で自動作成。理由・続柄を選ぶだけでそのまま使える例文が完成。印刷・Word・コピー対応。", href: "/tools/nenga-jimai-maker", emoji: "✉️", category: "冠婚葬祭・文書", isNew: true, updatedAt: "2026-09-06" },
  { id: "meimeisho-maker", title: "命名書メーカー", seoTitle: "命名書メーカー｜無料でお七夜の命名書を毛筆風に作成【印刷対応】", description: "赤ちゃんの命名書を毛筆風フォントで無料作成。正式・略式両対応、お七夜の飾り方も解説。A4・色紙サイズ印刷対応。", href: "/tools/meimeisho-maker", emoji: "👶", category: "冠婚葬祭・文書", isNew: true, updatedAt: "2026-09-06" },
  ...
  { id: "brand-color-text", title: "ブランドカラー×文字色 提案", seoTitle: "ブランドカラー×文字色 自動提案｜背景色に合う読みやすい文字色【無料】", description: "背景色を選ぶだけで読みやすい文字色をWCAG基準で自動提案。コントラスト比・プレビュー・HEX/RGB/CSS/Tailwindコピー対応。", href: "/tools/brand-color-text", emoji: "🎨", category: "カラーツール", isNew: true, isPopular: true },
  { id: "palette-accessibility", title: "配色アクセシビリティチェッカー", seoTitle: "配色アクセシビリティチェッカー｜パレット全体をWCAG一括判定【無料】", description: "複数の色をまとめて登録し、全組み合わせのコントラストをWCAG AA/AAAで一括判定。本文に使える配色がひと目でわかる。", href: "/tools/palette-accessibility", emoji: "🎨", category: "カラーツール", isNew: true },
  { id: "color-blind-simulator", title: "色覚シミュレーター", seoTitle: "色覚シミュレーター｜配色が色覚多様性でどう見えるか確認【無料】", description: "選んだ色がP型・D型・T型などの色覚でどう見えるかをシミュレーション。見分けにくい組み合わせを自動警告。", href: "/tools/color-blind-simulator", emoji: "🎨", category: "カラーツール", isNew: true },
  { id: "color-codes", title: "SNS・Webカラーコード一覧", seoTitle: "SNS・Webカラーコード一覧｜ブランドカラーのHEX・RGBをコピー【無料】", description: "X・LINE・Instagram・PayPayなど主要SNSのブランドカラーと、Web基本色・和色のHEX・RGBを一覧でコピー。", href: "/tools/color-codes", emoji: "🎨", category: "カラーツール", isNew: true },
  // 建設・リフォーム

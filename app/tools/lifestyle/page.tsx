  ...
  <div className="space-y-8">
    <section>
      ...
      <div className="grid sm:grid-cols-2 gap-3">
        {[
          { name: "副業利益・税金計算", use: "副業収入から経費・税金を差し引いた実質手取りを計算。20万円超えで確定申告が必要かどうかの目安も確認できる。" },
          { name: "YouTube SEOツール", use: "動画タイトルの文字数チェック・ハッシュタグ最適化・サムネイルのアスペクト比確認をまとめてできるツール。" },
          { name: "SNSリンクまとめ", use: "X・Instagram・TikTok・YouTubeなど複数のSNSリンクをまとめた共有ページを即生成。プロフィール欄のリンク先として使える。" },
        ].map(({ name, use }) => (

...
const MODES: Record<ModeId, {
  ...
  quick: {
    ...
    estimate: "最大約55MB",
    pings: 6,
    dl: { ms: 6000, cap: 40 * 1024 * 1024, conns: 2, init: 1 * 1024 * 1024 },
    ul: { ms: 4000, cap: 15 * 1024 * 1024, conns: 1 },
  },
  standard: {
    label: "標準",
    desc: "約10〜15秒・バランス",
    estimate: "最大約190MB",
    pings: 8,
    dl: { ms: 11000, cap: 150 * 1024 * 1024, conns: 3, init: 2 * 1024 * 1024 },
    ul: { ms: 6000, cap: 40 * 1024 * 1024, conns: 2 },
  },
  ultra: {
    label: "高精度・超高速",
    desc: "約15〜25秒・ギガ回線向け",
    estimate: "最大約700MB",
    pings: 8,
    dl: { ms: 18000, cap: 600 * 1024 * 1024, conns: 6, init: 4 * 1024 * 1024 },
    ul: { ms: 8000, cap: 100 * 1024 * 1024, conns: 3 },
    warning: true,
  },
};

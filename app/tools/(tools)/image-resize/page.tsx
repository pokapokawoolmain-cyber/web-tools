...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: { "@type": "Answer", text: "このツールでは「中央切り抜き（歪みなし・はみ出た部分をカット）」と「引き伸ばし（全体を残すが歪む）」の2つの変換方法を選べます。標準は中央切り抜きです。大切な被写体が端にある場合は、アップロード前に写真アプリで構図を調整することをおすすめします。" },
    },
    {
      "@type": "Question",
  ...
  <div className="space-y-6 text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
    ...
    <div className="space-y-3">
      <div>
        ...
        <p>「中央切り抜き（歪みなし）」と「引き伸ばし（全体を残す）」を選べます。標準の中央切り抜きでは、比率からはみ出た部分がカットされます。被写体が端にある場合は、事前に写真アプリで構図調整をおすすめします。</p>
      </div>
      <div>

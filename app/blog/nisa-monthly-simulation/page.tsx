  ...
  return (
    ...
    <BlogLayout post={post}>
      <p className="text-[16px] leading-loose font-medium text-slate-800 dark:text-zinc-100">
        「毎月5万円積み立てたら30年後にいくらになるんだろう」と気になって調べても、「複利の力はすごい」という話ばかりで具体的な金額が出てこないことが多い。
      </p>
      <p>
        この記事では、月1万・3万・5万・7万・10万円のパターンを、利回り3%・5%・7%それぞれで10年・20年・30年後の資産額をすべて計算して一覧にまとめました。あわせて、新NISAの非課税メリットが実際にどれくらいの金額になるか、いつ始めるのがいいか、暴落したときどうするかも解説しています。
      </p>
      ...
      <p>
        利回りの目安として、S&amp;P500や全世界株式インデックス（いわゆる「オルカン」）の過去20〜30年の年率リターンはおおよそ7〜10%程度です。ただし手数料・為替コスト・今後の不確実性を加味すると、5〜7%が現実的な想定ラインとされています。3%は債券や高配当株を組み合わせた保守的なポートフォリオを想定した数字です。
      </p>
      ...
      <p>
        月1万円でも30年・利回り7%なら1,200万円を超えます。元本360万円が3倍以上になる計算です。「少額だから意味がない」ということはなく、30年という時間が複利の力を最大限に引き出してくれます。
      </p>
      ...
      <p>
        利回り7%・30年で3,600万円超え。元本の約3.4倍です。利回り3%でも1,749万円なので、元本の約1.6倍になる計算です。利回りの想定でここまで変わるのが複利の特徴で、だからこそ「どの利回りで考えるか」を慎重に決めることが重要です。
      </p>
      ...
      <p>
        月5万円・30年で元本ちょうど1,800万円。これは新NISAの非課税保有限度額と同じ金額です。つまり月5万円を30年間積み立てると、非課税枠の上限にぴったり達する計算です。利回り5%なら4,163万円で、運用益だけで2,363万円。その全額が非課税になるのが新NISAの最大のメリットです。
      </p>
      ...
      <p>
        25歳と45歳では最終資産に大きな差がありますが、45歳から始めても20年で2,000万円を超えます。「もう遅い」ということはありません。始めるなら早いほど有利ですが、今日が残りの人生で最も若い日です。
      </p>

      <hr className="border-slate-100 dark:border-zinc-800 my-2" />
      <h2>積立額の選び方：現実的な目安</h2>
      <p>
        よく言われる目安は「手取りの20〜30%を積立に回す」ですが、これはあくまで参考値です。家賃・子育て・奨学金返済などの固定費によって、現実的な積立額は人によって大きく異なります。
      </p>
      <p>
      ...
      <p>
        1,800万円の非課税枠は義務ではありません。自分のペースで積み立てれば十分です。月5万円で30年かければちょうど1,800万円になります。無理して満額を追う必要はありません。
      </p>

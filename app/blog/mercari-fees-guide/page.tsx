...
export const metadata: Metadata = generateMeta({
  ...
  description: "メルカリの実質コストは販売手数料10%＋送料＋梱包材＋振込手数料200円。1,000円で売るとネコポス175円込みで手取り725円、振込までするとさらに200円減。売値別早見表と利益計算ツールで出品前に儲けがわかります。",
  path: `/blog/${post.slug}`,
  keywords: ["メルカリ 手数料 計算", "メルカリ 手数料 いくら", "メルカリ 手取り 計算", "メルカリ 送料 いくら", "メルカリ 振込手数料", "メルカリ 利益 計算 ツール", "メルカリ ネコポス 手取り 早見表"],
  type: "article",
});
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    {
      "@type": "Question",
      name: "メルカリの売上を振り込むとき振込手数料はかかりますか？",
      acceptedAnswer: { "@type": "Answer", text: "はい。メルカリの売上金を銀行口座に振り込む際は、振込金額にかかわらず1回あたり200円の振込手数料がかかります。翌営業日までに振り込まれる「お急ぎ振込」を利用する場合はさらに200円が加算されます。売上をメルペイとしてそのまま使えば振込手数料はかかりません。" },
    },
    {
      "@type": "Question",
  ...
  return (
    ...
    <BlogLayout post={post}>
      ...
      <div className="bg-blue-50 dark:bg-blue-950/30 rounded-xl p-5 my-6 border border-blue-200 dark:border-blue-800">
        <strong className="text-blue-800 dark:text-blue-300 block mb-1">出品前に利益を自動計算</strong>
      ...
      <p>
        さらに見落としがちなのが<strong>振込手数料</strong>です。売上金を銀行口座へ振り込む際は、金額にかかわらず<strong>1回あたり200円</strong>の振込手数料がかかります（翌営業日までに振り込まれる「お急ぎ振込」はさらに＋200円）。売上をメルペイとしてそのまま買い物に使う場合は不要ですが、現金化する前提なら実質コストに含めて考える必要があります。
      </p>
      <p>
      ...
      <ul className="space-y-2">
        ...
        <li>現金化まで含める場合：手取り ＝ 販売価格 − 手数料（10%）− 送料 − 梱包材費 − 振込手数料200円</li>
      </ul>
      <div className="bg-amber-50 dark:bg-amber-950/20 rounded-xl p-4 my-6 border border-amber-200 dark:border-amber-800">
        <p className="text-[14px] text-slate-700 dark:text-zinc-300 m-0">
          <strong className="text-amber-800 dark:text-amber-300">実質コストの総合計算式</strong>：メルカリで実際にかかるコストは「<strong>販売手数料10%＋送料＋梱包材＋振込手数料200円</strong>」です。表面上の手数料10%だけで価格を決めると、現金化した時点で想定より数百円少なくなります。振込は売上をまとめて申請すれば200円×1回で済むため、こまめな振込申請は避けるのが得策です。
        </p>
      </div>
      ...
      <p className="text-[13px] text-slate-500 dark:text-zinc-500">
        ※2026年7月現在の料金です。配送料金は改定されることがあるため、最新の料金はメルカリ公式サイトでご確認ください。
      </p>
      ...
      <dl className="space-y-4">
        {[
          ...
          { q: "売上金の振込に振込手数料はかかりますか？", a: "はい。銀行口座への振込は金額にかかわらず1回200円の振込手数料がかかります。お急ぎ振込はさらに+200円です。メルペイとしてそのまま使えば手数料はかかりません。" },

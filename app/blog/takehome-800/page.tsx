...
export const metadata: Metadata = generateMeta({
  ...
  description: "年収800万円の手取りは年間約589万円・月49.1万円。所得税57万・住民税46万・社会保険料108万、控除211万円の詳細を解説。独身と家族持ちの生活費シミュレーション、ふるさと納税・iDeCoの節税効果も。",
  path: `/blog/${post.slug}`,
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: { "@type": "Answer", text: "年収800万円の手取りは年間約589万円（月平均49.1万円）が目安です。所得税約57万円・住民税約46万円・社会保険料約108万円の合計約211万円が控除されます。家族構成・加入する健康保険・各種控除により実際の金額は変わります。" },
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      acceptedAnswer: { "@type": "Answer", text: "年収800万円では課税所得が約450万円となり、所得税率20%が適用されます。年収700万円（所得税約33万円）に比べて所得税が約24万円増えており、iDeCoやふるさと納税を使うことで課税所得を下げ、節税効果が大きく出る年収帯です。" },
    },
    {
      "@type": "Question",
      name: "年収800万円から節税する方法はありますか？",
      acceptedAnswer: { "@type": "Answer", text: "主な節税方法は①ふるさと納税（年収800万・独身で年12〜13万円が上限目安）②iDeCo（月2.3万円まで全額所得控除・所得税20%+住民税10%で年約8〜9万円節税）③住宅ローン控除（年末残高の0.7%を最大13年間税額控除）の3つです。年収800万円台は税負担が大きく、節税効果の恩恵を最も受けやすい年収帯です。" },
    },
  ],
};
  ...
  return (
    ...
    <BlogLayout post={post}>
      <p className="text-[16px] leading-loose font-medium text-slate-800 dark:text-zinc-100">
        年収800万円の給与明細を初めて見たとき、控除欄の合計が211万円という数字に目を疑いました。所得税57万・住民税46万と年収700万円台から大きく増え、税負担の重さを実感しました。年収800万円の手取りは<strong>約589万円（月49.1万円）</strong>が目安です。控除211万円の内訳と節税・FIRE積立の戦略を解説します。
      </p>
      ...
      <p>
        年収800万円では所得税が<strong>57万円</strong>、住民税が<strong>46万円</strong>と年収700万円台から大きく増えます。所得税率20%区分の中でも高い水準となり、節税対策の効果が最も出やすい年収帯です。
      </p>
      ...
      <ul className="space-y-2">
        ...
        <li>
          <strong>iDeCo</strong>：月2.3万円（年27.6万円）まで全額所得控除。年収800万円の所得税率20%+住民税10%なら年間約8〜9万円の節税効果。老後資金を積み立てながら節税できます。
        </li>
        <li>
      ...
      <div className="bg-amber-50 dark:bg-amber-950/30 rounded-xl p-5 my-6 text-[14px] border border-amber-200 dark:border-amber-800">
        ...
        <p className="text-amber-700 dark:text-amber-400 leading-relaxed">
          この年収帯で一番インパクトがあったのは、ふるさと納税の上限額が思ったより大きかったことです。独身で約12〜13万円まで寄附できるので、米・肉・魚介などをまとめて選んで食費を実質カットしました。iDeCoは掛金が全額所得控除になるため、年収800万円台の所得税20%+住民税10%で計算すると月2.3万円の掛金で年間約8万円以上の節税になります。住宅ローン控除と合わせると年間10万円以上の節税になり、手取りを実質的に増やす感覚でした。
        </p>
      </div>

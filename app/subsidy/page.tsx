...
export const metadata: Metadata = {
  title: "補助金・助成金診断｜個人事業主・中小企業向けマッチングツール【無料】",
  description:
    "個人事業主・中小企業向けに、事業内容・地域・目的から使える可能性のある補助金・助成金を無料診断。IT導入・販路開拓・設備投資・採用・賃上げなど目的別に確認できます。登録不要・約2分・スマホ対応。",
  keywords: "補助金診断, 助成金診断, 補助金マッチング, 個人事業主 補助金, 中小企業 助成金, IT導入補助金, 持続化補助金, 業務改善助成金, 無料",
      ...
      <section className="bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 text-white pt-12 pb-14 sm:pt-16 sm:pb-20">
        <div className="container-base max-w-4xl">
          ...
          <p className="text-blue-100 text-[15px] sm:text-base leading-relaxed mb-6 max-w-2xl">
            個人事業主・中小企業が使える可能性のある補助金・助成金を無料で診断。
            事業内容・地域・目的から8問でマッチング。
          </p>
      ...
      <main id="main" className="container-base max-w-4xl py-8 sm:py-12">
        <div className="grid lg:grid-cols-[1fr_260px] gap-8 items-start">
          ...
          <div>
            ...
            <p className="text-slate-500 dark:text-slate-400 text-[13px] mb-5">8つの質問に答えるだけ。個人事業主・中小企業に対応。</p>
            <DiagnosisForm />
          </div>

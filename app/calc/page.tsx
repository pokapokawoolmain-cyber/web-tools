...
const config = CATEGORY_CONFIGS["calc"]!;
...
export default function CalcCategoryPage() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "計算ツール", item: `${siteUrl}/calc` },
    ],
  };
      ...
      <div className="container-base py-12 sm:py-16 space-y-16">
        ...
        <div className="rounded-2xl bg-slate-50 dark:bg-zinc-900 border border-slate-200 dark:border-zinc-700 p-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="font-semibold text-slate-800 dark:text-zinc-200 mb-1">すべてブラウザ内で計算・登録不要</p>
              <p className="text-[13px] text-slate-500 dark:text-zinc-500 leading-relaxed">
                割り勘・年齢・消費税・BMIなどの計算はすべてブラウザ内で処理されます。入力したデータが外部サーバーに送信されることはなく、インストール・ログイン不要でご利用いただけます。
              </p>
            </div>
          </div>
        </div>

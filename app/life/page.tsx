...
const config = CATEGORY_CONFIGS["life"]!;
...
export default function LifeCategoryPage() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "生活・便利ツール", item: `${siteUrl}/life` },
    ],
  };
      ...
      <div className="container-base py-12 sm:py-16 space-y-16">
        ...
        <div className="rounded-2xl bg-slate-50 dark:bg-zinc-900 border border-slate-200 dark:border-zinc-700 p-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="font-semibold text-slate-800 dark:text-zinc-200 mb-1">カメラ・音声は録画も送信もしません</p>
              <p className="text-[13px] text-slate-500 dark:text-zinc-500 leading-relaxed">
                マイク・Webカメラ・スピーカーの確認は、映像や音声をブラウザ内で表示・解析するだけで、録画・保存・外部送信は一切行いません。すべてのツールがブラウザ内で完結します。
              </p>
            </div>
          </div>
        </div>

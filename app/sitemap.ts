...
const RECENTLY_UPDATED_TOOL_IDS = new Set<string>([
  ...
  "speed-test", "ai-email", "ai-keigo", "ai-apology", "ai-decline", "ai-inquiry", "prompt-builder",
  // コンテンツ・機能を大幅更新したツール
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    // 計算・生活カテゴリ
    { url: `${siteUrl}/calc`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.9 },
    { url: `${siteUrl}/life`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.9 },
    // カラーツール

...
export function HeroPreviewDeck() {
  ...
  return (
    <div className="relative">
      ...
      <div
        aria-hidden="true"
        className="hidden lg:block absolute -bottom-10 -left-10 z-10 drop-shadow-2xl"
      >
        <div className="w-[108px] bg-[#111] rounded-[24px] p-[4px] ring-1 ring-white/10 shadow-2xl">
          {/* ノッチエリア */}
          <div className="bg-[#111] rounded-t-[20px] h-5 flex items-end justify-center pb-[3px]">
            <div className="w-12 h-3 bg-[#111] rounded-full ring-1 ring-white/10" />
          </div>
          {/* スクリーン */}
          <div
            className={[

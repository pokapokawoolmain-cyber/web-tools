...
export const tools: Tool[] = [
  ...
  // ── 新規6ツール ─────────────────────────────
  {
    ...
    category: "text",
    isNew: true,
    keywords: ["WiFi QRコード", "Wi-Fi共有", "QR生成", "パスワード不要接続"],
  },
  {
    id: "furusato",
    ...
    category: "lifestyle",
    isNew: true,
    keywords: ["ふるさと納税", "控除上限", "年収別計算", "配偶者控除", "扶養控除"],
  },
  {
    id: "net-income",
    title: "手取り計算",
    description: "年収を入力するだけで月間・年間の手取り額を計算。社会保険料・所得税・住民税の内訳も確認。",
    href: "/net-income",
    icon: "💴",
    category: "finance",
    isNew: true,
    keywords: ["手取り計算", "年収 手取り", "税金計算", "社会保険料", "月収 手取り"],
  },
  {
    id: "sns-links",
    title: "SNSリンクまとめ",
    description: "X・Instagram・TikTok・YouTubeなど複数のSNSリンクをまとめた共有ページを即生成。",
    href: "/sns-links",
    icon: "🔗",
    category: "text",
    isNew: true,
    keywords: ["SNSリンクまとめ", "プロフィールリンク", "リンクまとめ", "SNS共有", "bio link"],
  },
  {
    id: "gpa",
    title: "GPA計算",
    ...
    category: "lifestyle",
    isNew: true,
    keywords: ["GPA計算", "大学 GPA", "成績計算", "単位 GPA", "累積GPA"],
  },
  {
    id: "shift-salary",
    title: "シフト給与計算",
    ...
    category: "calc",
    isNew: true,
    keywords: ["シフト 給与計算", "時給計算", "アルバイト 月収", "深夜手当", "パート 収入計算"],
  },
];
